  ...
  return (
    <main style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', zIndex: 10 }}>
      <div style={{ textAlign: 'center', pointerEvents: 'none' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'var(--text-3xl)', color: 'var(--text-primary)' }}>Work</h1>
        <p style={{ color: 'var(--text-secondary)', marginTop: '1rem' }}>Deep Engineering & Design Archives — Phase 4</p>
      </div>
    </main>
  )
}
